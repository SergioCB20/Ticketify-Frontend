...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Si no hay error, NextAuth redirigirá automáticamente
    } catch (err) {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex justify-center items-center">
            <button
              ...
              disabled={loading || loadingGoogle}
              className="flex items-center justify-center gap-3 h-12 px-16 border-2 border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
